import numpy as np
f1=open("2013Mmonth.txt","r")
f2=open("2013Mday.txt","r")
f3=open("2013Mhour.txt","r")
f7=open("2013Mweekday.txt","r")
A=f1.read().splitlines()
B=f2.read().splitlines()
C=f3.read().splitlines()
D=f7.read().splitlines()
f4=open("2013Mfreq_m","w")
f5=open("2013Mfreq_d","w")
f6=open("2013Mfreq_h","w")
f8=open("2013Mfreq_wd","w")
