library(ggplot2)
#Generate the data
A=read.table("/Users/StanleyLIn/Desktop/專題研究/2014Ffreq_d")
print(A)
B=A
A=as.matrix(A)
#print(A)
...
print(arr)
s=ggplot(df, aes(x = gp, y = y))+geom_line(color="#CAA661")+geom_text(label=arr,check_overlap = TRUE)+ggtitle("2014_Female_Days", subtitle = NULL)
s