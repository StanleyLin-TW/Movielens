import numpy as np
f1=open("2014Fmonth.txt","r")
f2=open("2014Fday.txt","r")
f3=open("2014Fhour.txt","r")
f7=open("2014Fweekday.txt","r")
A=f1.read().splitlines()
B=f2.read().splitlines()
C=f3.read().splitlines()
D=f7.read().splitlines()
f4=open("2014Ffreq_m","w")
f5=open("2014Ffreq_d","w")
f6=open("2014Ffreq_h","w")
f8=open("2014Ffreq_wd","w")
